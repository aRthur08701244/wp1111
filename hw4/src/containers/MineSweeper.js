...
const MineSweeper = () => {
    ...
    const startGameOnClick = () => {
        refRoot.current.children[0].children[1].onclick = () => setStartGame(true)
    }
    ...
    return (
        <div className='mineSweeper' ref={refRoot} >
            ...
            {!startGame ? <HomePage mineNumOnChange={mineNumOnChange} boardSizeOnChange={boardSizeOnChange} mineNum={mineNum} boardSize={boardSize} setStartGame={setStartGame} /> : <></>}
